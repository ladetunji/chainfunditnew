...
async function bulkImportCampaigns() {
  console.log('📊 Bulk Importing Campaigns from Excel...\n');
  ...
  try {
    ...
    if (!fs.existsSync(excelPath)) {
      ...
      console.log('📋 Please create a file named "campaigns-data.xlsx" in the project root with the following columns:');
      ...
      console.log('\n💡 You can also use CSV format by naming the file "campaigns-data.csv"');
      return;
    }
