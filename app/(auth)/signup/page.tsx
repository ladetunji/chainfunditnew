...
export default function SignupPage() {
  return (
    <div className="flex flex-col gap-2 items-center justify-center px-2 md:px-0">
      <Image
        src="/images/logo.svg"
      ...
      <div className="flex flex-1 items-center justify-center w-full">
        <div className="w-full max-w-md md:max-w-lg pt-4 md:pt-6">
          <SignupForm />
        </div>
      </div>
      <div
        className="flex flex-col md:flex-row gap-2 md:gap-4 items-center px-2 md:px-5 py-6 md:py-8 mt-6 md:mt-10 w-full"
        style={{
