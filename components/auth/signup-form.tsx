    ...
    <form className={cn("flex flex-col gap-6 w-full pt-5", className)} onSubmit={handleSubmit} {...props}>
      <div className="grid gap-6">
        ...
        <div className="flex gap-3 md:gap-5">
          <Button className="w-[200px] md:w-[236px] h-16 bg-[#D9D9DC] border-[#8E8C95] text-[#474553] font-medium text-2xl" type="button" onClick={() => window.location.href = '/api/auth/[...betterauth]?provider=google'}>
            <FaGoogle color="#474553" size={32} /> Google
          </Button>
          <Button className="w-[200px] md:w-[236px] h-16 bg-[#D9D9DC] border-[#8E8C95] text-[#474553] font-semibold text-2xl" type="button" onClick={() => window.location.href = '/api/auth/[...betterauth]?provider=facebook'}>
